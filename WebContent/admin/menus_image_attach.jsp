...
<main class="content">
  ...
  <div style="display:flex;gap:40px;align-items:flex-start;flex-wrap:wrap;margin-top:24px;">
    ...
    <div class="card" style="flex:1;min-width:260px;">
      ...
      <form method="post" action="<%=ctx%>/admin/menus_new/image" enctype="multipart/form-data">
        ...
        <input type="file" name="imageFile" accept="image/*" style="margin-bottom:12px;" />
    ...
    <div class="card" style="flex:2;min-width:300px;text-align:center;">
      ...
      <c:choose>
        <c:when test="${not empty menuDay.imagePath}">
          <img src="<%=ctx%>/${menuDay.imagePath}" alt="登録済み画像"
  ...
  <div style="margin-top:24px;">
    <a class="button ghost" href="<%=ctx%>/admin/menus_new/select?dayId=${menuDay.id}">← 時間帯選択に戻る</a>
  </div>
</main>
